...
public class DTree {
    ...
    public DTree(String id, String parentId, String title, Boolean spread, Boolean last, Boolean hide, Boolean disabled, String iconClass, Object basicData, List<CheckArr> checkArr, List<DTree> children) {
        this.id = id;
        this.parentId = parentId;
        this.title = title;
        this.spread = spread;
